...
| Microsoft Whiteboard | Mapeamento e síntese colaborativa | Mapa de raciocínio e prioridade | Notas adesivas e versão textual | https://support.microsoft.com/en-us/whiteboard/use-whiteboard-in-a-teams-meeting |
| Microsoft Loop | Coautoria sincronizada e revisão | Canvas com autoria e nova versão | Word no SharePoint | https://support.microsoft.com/en-us/loop/get-started-with-microsoft-loop |
| SharePoint e OneDrive | Coautoria, versões e continuidade | Artefato compartilhado e histórico | Arquivo local com protocolo de versão | https://learn.microsoft.com/en-us/sharepoint/teams-connected-sites |
...
- Loop não deve ser pressuposto para convidados externos.
- Whiteboard depende das políticas de compartilhamento da organização.
- A gravação do PowerPoint Live não captura todos os elementos da experiência.
