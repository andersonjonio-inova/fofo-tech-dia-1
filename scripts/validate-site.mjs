...
check('Dia 1 desktop', state.title.includes('Dia 1') && state.overflow && state.activities === 6 && state.resources === 6 && state.external, JSON.stringify(state));
...
await evaluate(`Reveal.next()`); await wait(250);
check('Navegação do deck', (await evaluate(`Reveal.getIndices().h`)) === 1, 'avançou para o slide 2');
